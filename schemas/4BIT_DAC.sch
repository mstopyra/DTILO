...
C {devices/lab_pin.sym} 2080 -790 0 0 {name=p10 sig_type=std_logic lab=VBN}
...
C {devices/opin.sym} -310 -820 2 0 {name=p7 lab=I_DUMP}
C {madvlsi/gnd.sym} -810 -730 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 2080 -700 0 0 {name=p12 sig_type=std_logic lab=VCN}
